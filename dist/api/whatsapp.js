...
var Whatsapp = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.page.waitForFunction(function () {
                            /* atualizado dia 10/06/2020 */
                            //var useHereClass = '._1WZqU.PNlAR'; 
    ...
    /* check session lost */
    Whatsapp.prototype.checkUnpaired = function(){

        var useHereClass = '.S7_rT.FV2Qy';
        var rs = document.querySelector(useHereClass);
        var result = false;
     ...
     */
    /* update 15-08-2020 VN */
    Whatsapp.prototype.downloadFile = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var url, encBase64;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(message.isMedia || message.isMMS)) return [3 /*break*/, 2]; /* PONTO DA ULTIMA ATUALIZA dia 15-08-2020*/
