        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!(BROKEN_METHODS.length > 0)) return [3 /*break*/, 12];
                ...
                case 6:
                    //check again
                    BROKEN_METHODS = _a.sent();
                    if (!(BROKEN_METHODS.length > 0)) return [3 /*break*/, 10];
                    spinner.info('Unable to repair. Reporting broken methods.');
                    if (!notifier.update) return [3 /*break*/, 7];
                    //needs an updated
                    spinner.fail("!!!BROKEN METHODS DETECTED!!!\n\n Please update to the latest version: " + notifier.update.latest);
                    return [3 /*break*/, 9];
                case 7: return [4 /*yield*/, axios_1.default.post(pkg.brokenMethodReportUrl, __assign(__assign({}, debugInfo), { BROKEN_METHODS: BROKEN_METHODS })).catch(function (e) { return false; })];
                case 8:
                    report = _a.sent();
                ...
                case 10:
                    spinner.succeed('Session repaired.');
                    _a.label = 11;
                case 11: return [3 /*break*/, 13];
                case 12:
                    spinner.succeed('Passed Integrity Test');
                    _a.label = 13;
